...
public class Program {
    ...
    private static void Main(string[] args) {
        ...
        // ------------------------------------
        Shader ourShader = new Shader("../../../shaders/materials_vs.glsl", "../../../shaders/materials_fs.glsl");
        ...
        window.RenderFrame += delegate(FrameEventArgs args) {
            ...
            */
            ...
            lightingShader.setFloat("spotLight.cutOff", (float)Math.Cos(MathHelper.DegreesToRadians(12.5f)));
            lightingShader.setFloat("spotLight.outerCutOff", (float)Math.Cos(MathHelper.DegreesToRadians(15.0f)));
