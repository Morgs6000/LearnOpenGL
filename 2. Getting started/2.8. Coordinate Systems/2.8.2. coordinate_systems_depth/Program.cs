...
public class Program {
    ...
    private static void Main(string[] args) {
        ...
        window.RenderFrame += delegate(FrameEventArgs args) {
            ...
            // passa-os para os shaders (3 maneiras diferentes)
            GL.UniformMatrix4(modelLoc, false, ref model);
            GL.UniformMatrix4(viewLoc, false, ref view);
            // nota: atualmente definimos a matriz de projeção em cada quadro, mas como a matriz de projeção raramente muda, geralmente é uma boa prática defini-la fora do loop principal apenas uma vez.
