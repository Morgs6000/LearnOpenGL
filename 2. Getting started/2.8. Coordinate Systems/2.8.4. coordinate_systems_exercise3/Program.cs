...
public class Program {
    ...
    private static void Main(string[] args) {
        ...
        window.RenderFrame += delegate(FrameEventArgs args) {
            ...
            //passa matrizes de transformação para o shader
            ourShader.setMat4("projection", projection); // nota: atualmente definimos a matriz de projeção em cada quadro, mas como a matriz de projeção raramente muda, geralmente é uma boa prática defini-la fora do loop principal apenas uma vez.
            ...
            for(int i = 0; i < 10; i++) {
                ...
                float angle = 20.0f * i;
                if(i % 3 == 0) { // a cada 3ª iteração (incluindo a primeira) definimos o ângulo usando a função de tempo do GLFW.
