...
public class Program {
    ...
    private static float yaw = -90.0f; // a guinada é inicializada em -90,0 graus, pois uma guinada de 0,0 resulta em um vetor de direção apontando para a direita, então inicialmente giramos um pouco para a esquerda.
    ...
    private static void Main(string[] args) {
        ...
        window.RenderFrame += delegate(FrameEventArgs args) {
            ...
            Matrix4 projection = Matrix4.CreatePerspectiveFieldOfView(MathHelper.DegreesToRadians(fov), (float)SCR_WIDTH / (float)SCR_HEIGHT, 0.1f, 100.0f);
