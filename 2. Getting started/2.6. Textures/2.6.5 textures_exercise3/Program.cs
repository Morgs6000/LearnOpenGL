...
public class Program {
    ...
    private static void Main(string[] args) {
        ...
        // ------------------------------------------------------------------
        float[] vertices = {
            // positions          // colors           // texture coords (observe que nós os alteramos para 'aumentar o zoom' em nossa imagem de textura)
        ...
        GL.TexParameter(TextureTarget.Texture2D, TextureParameterName.TextureWrapS, (int)TextureWrapMode.ClampToEdge); // define o empacotamento de textura para GL_REPEAT (método de empacotamento padrão)
        ...
        GL.Uniform1(GL.GetAttribLocation(ourShader.ID, "texture1"), 0);
