...
public class Program {
    ...
    private static void Main(string[] args) {
        ...
        window.RenderFrame += delegate(FrameEventArgs args) {
            ...
            lightingShader.setFloat("light.cutOff", (float)Math.Cos(MathHelper.DegreesToRadians(12.5f)));
            lightingShader.setFloat("light.outerCutOff", (float)Math.Cos(MathHelper.DegreesToRadians(17.5f)));
            lightingShader.setVec3("viewPos", camera.Position);

            // propriedades da luz
            lightingShader.setVec3("light.ambient", 0.1f, 0.1f, 0.1f);
            // configuramos a intensidade difusa um pouco maior; as condições de iluminação corretas variam de acordo com cada método de iluminação e ambiente.
            // cada ambiente e tipo de iluminação requer alguns ajustes para tirar o melhor proveito do seu ambiente.
